sap.ui.define([
    ...
    function (JSONModel, Controller, LayeredLayout, ForceBasedLayout, ActionButton, Node, Fragment) {
        "use strict";
var GraphController = Controller.extend("enterprisesustainabilitypro.controller.OrgStructure");
		...
		GraphController.prototype.onInit = function () {
			...
			this._oModel = new JSONModel(sap.ui.require.toUrl("enterprisesustainabilitypro/utils/graph.json"));
		...
		GraphController.prototype._openDetail = function (oNode, oButton) {
			...
			if (!this._oQuickView) {
				Fragment.load({
					name: "enterprisesustainabilitypro.fragments.TooltipFragment",
					type: "XML"
